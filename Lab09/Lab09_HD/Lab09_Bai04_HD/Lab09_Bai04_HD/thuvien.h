...
void Chen_SV(char *maSV, char *hoLot, char *ten, char *gioiTinh,
	unsigned namSinh, char *queQuan, char *lop, double diem, SinhVien *a, int &n)
{
	if (n < MAX)
	{
...
void XuatSinhVien_1_Lop(SinhVien *a, int n, char lop[])
{
	XuatTieuDe();
	cout << "\n";
	for (int i = 0; i < n; i++)
...
void XuatSinhVienTheoLop(SinhVien *a, int n)
{
	SinhVien *lop = new SinhVien[MAX];
	int m = 0;
	int dau;
	...
	{
		cout << "\n\n =============================== " << (a + j)->lop << " ===============================\n";
		XuatSinhVien_1_Lop(a, n, (a + j)->lop);
	}
}

void DSSV_Lop(SinhVien *a, int n, char lop[], SinhVien *dsLop, int &h)
{
	int kq = n;
	int i;
	for (i = 0; i < n; i++)
...
void Xuat_DSSV_Lop(SinhVien *a, int n, char lop[])
{
	SinhVien *dsLop;
	int i, h;
